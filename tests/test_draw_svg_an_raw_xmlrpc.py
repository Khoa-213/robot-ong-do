...
DEFAULT_SVG_PATH = PROJECT_ROOT / "assets" / "svg" / "an.svg"
LOG_PREFIX = "[RAW_SVG_AN]"


def main() -> None:
    parser = argparse.ArgumentParser(description="Draw assets/svg/an.svg as separate writing strokes.")
