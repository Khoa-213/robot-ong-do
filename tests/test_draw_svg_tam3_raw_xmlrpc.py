...
DEFAULT_SVG_PATH = PROJECT_ROOT / "assets" / "svg" / "tam3.svg"
LOG_PREFIX = "[RAW_SVG_TAM3]"


def main() -> None:
    parser = argparse.ArgumentParser(description="Draw assets/svg/tam3.svg as separate writing strokes.")
