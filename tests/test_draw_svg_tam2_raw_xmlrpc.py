...
DEFAULT_SVG_PATH = PROJECT_ROOT / "assets" / "svg" / "tam2.svg"
LOG_PREFIX = "[RAW_SVG_TAM2]"


def main() -> None:
    parser = argparse.ArgumentParser(description="Draw assets/svg/tam2.svg as separate writing strokes.")
