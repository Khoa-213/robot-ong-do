...
DEFAULT_SVG_PATH = PROJECT_ROOT / "assets" / "svg" / "an1.svg"
LOG_PREFIX = "[RAW_SVG_AN1]"


def main() -> None:
    parser = argparse.ArgumentParser(description="Draw assets/svg/an1.svg as separate writing strokes.")
