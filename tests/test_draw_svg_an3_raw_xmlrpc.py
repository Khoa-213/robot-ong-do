...
DEFAULT_SVG_PATH = PROJECT_ROOT / "assets" / "svg" / "an3.svg"
LOG_PREFIX = "[RAW_SVG_AN3]"


def main() -> None:
    parser = argparse.ArgumentParser(description="Draw assets/svg/an3.svg as separate SVG strokes.")
